...
public partial class madicare_Admin_Health : System.Web.UI.Page
{
    ...
    protected void btCreate_Click(object sender, EventArgs e)
    {
        ...
        if (FilePhoto.HasFile & FileUpload1.HasFile)
        {
            ...
            path = Server.MapPath("Health_Img");
            ...
            string str;
            str = "Insert into Health values('" + tbhealthname.Text + "','" + tbdescription.Text + "','" + maxval + ext + "','" + maxval1 + ext1 + "' )";
        ...
        Session["Health_Name"] = tbhealthname.Text;
