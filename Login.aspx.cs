...
public partial class madicare_Admin_Login : System.Web.UI.Page
{
    ...
    protected void btCreate_Click(object sender, EventArgs e)
    {
       SqlConnection con1 = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Faz\Desktop\sem6\App_Data\medicare.mdf;Integrated Security=True;User Instance=True");
        string str1;
        str1 = "Select Count(*) from AdminReg where Email='" +tbEmail .Text  + "'";
     ...
     //   city = cmb_city.SelectedItem .Text;
        ...
        if (i == 1)
        {
           ...
           ClientScript.RegisterStartupScript(Page.GetType(), "validation", "<script  language='javascript'>alert('Invalid AdminName is Already Exist')</script>");

        //    MessageBox.Show("AdminName is Already Exist");
        ...
        string str;
        str = "Insert into AdminReg values('" + tbUsername .Text  + "','" + tbPass1 .Text  + "','" + tbConfPass2 .Text  + "','" +tbEmail .Text  + "'," + tbmobile.Text  + ",'" +tbaddress .Text  + "','" + Gender  + "','" +cmb_city .Text    + "','" +cmb_area .SelectedItem .Text + "' )";
    ...
    //    ClientScript.RegisterStartupScript(Page.GetType(), "validation", "<script  language='javascript'>alert('Registration Successfully')</script>");
        Session["AdminName"] = tbUsername.Text;
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string str;
            str = "select count(*) from AdminReg where AdminName='" + tbLogin.Text + "' and Password='" + tbPassword.Text + "'";
            ...
            {
                ClientScript.RegisterStartupScript(Page.GetType(), "validation", "<script  language='javascript'>alert('Invalid AdminName and Password')</script>");
